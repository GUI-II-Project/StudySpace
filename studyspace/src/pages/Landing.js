  ...
  return (
    <div>
      ...
      <div style={{ marginTop: '2rem' }}>
        <img style={{ maxHeight: '500px' }} className="img-fluid" src={main_page} alt="main_page" />
      </div>
      ...
      >
        <div className="col-6 text-start">
          ...
          <p style={{ paddingTop: '1rem' }}>
            Imagine being so immersed in your studies that the perception of time fades away, distractions magically
            disappear, and learning feels practically effortless. This is the flow state, a powerful cognitive mode of
            complete focus and clarity.
          </p>
          <p style={{ paddingTop: '1rem' }}>
            But getting into flow state is hard. And one key barrier? Scattered study tools. It often feel like students
            spend more time setting up to study than actually studying. Constant application flipping and context
            switching breaks concentration and makes it harder to enter and sustain a flow state.
          </p>
      ...
      <div style={{ marginTop: '7rem', marginLeft: '8rem' }} className="row justify-content-left">
        <div className="col-5 text-start">
          <h4 style={{ paddingBottom: '5px', fontWeight: 'bold' }}>No more scattered tools. No more wasted time.</h4>
          <h5 className="text-muted">Just one platform to help you stay organized and focused.</h5>
        </div>
      ...
      <div
        id="features"
        style={{ marginTop: '2rem', marginBottom: '6rem', marginLeft: '8rem', marginRight: '8rem' }}
      ...
      >
        ...
        <div className="col-4">
          ...
          <p style={{ paddingTop: '5px' }}>
            Access an integrated calendar to add events and see what&apos;s coming next.
          </p>
        </div>
        <div className="col-4">
