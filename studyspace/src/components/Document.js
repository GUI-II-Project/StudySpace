...
class Document extends React.Component {
    ...
    componentDidMount() {
        if (this.props.documentRef && this.props.documentRef.current) {
            ...
            this.props.documentRef.current.addEventListener('keydown', this.handleKeyDown);
        }
    }
    ...
    componentWillUnmount() {
        if (this.props.documentRef && this.props.documentRef.current) {
            ...
            this.props.documentRef.current.removeEventListener('keydown', this.handleKeyDown);
        }
    }
